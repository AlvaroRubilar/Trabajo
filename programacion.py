...
<html lang="en">
  ...
  <body class="container">
    ...
    for k in range(0,len(lista_anuncios),2):
      ...
      j = j+1
    pagina_anuncios.append('\n</body>\n</html>')
    archivo = open('salida/programa/programa_'+asignatura+'_'+seccion+'.html',"w",encoding="utf-8")
    archivo.writelines(pagina)
    archivo.close()
    archivo2 = open('salida/anuncios/anuncios_'+asignatura+'_'+seccion+'.html',"w",encoding="utf-8")
